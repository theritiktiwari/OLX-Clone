...
const Listing = ({ siteName, auth }) => {
    document.title = `Listing | ${siteName}`;
            ...
            <section className='my-5 pt-5'>
                ...
                {getData ? <div className='container d-flex justify-conent-center align-items-center'>
                    {(getData.length > 0) ? <div className='table-responsive mb-4 container'>
                        ...
                        <div>
                            <h4 className='text-center w-100 fw-bold mb-4 text-secondary pb-4'>You didn&apos;t list any product.</h4>
                        </div>
                    </div>}
                </div> : <Loader />}
            </section>
